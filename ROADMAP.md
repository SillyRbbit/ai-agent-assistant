...
| 8. Desktop UI                                  | Prototype validated | Deterministic frontend-only Command Center fixture projection passed the approved M5 browser/Tauri matrix; no authoritative data or control                            | Preserve the verified prototype; live typed IPC remains separately Blocked                                |
