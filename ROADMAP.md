...
| Phase 5 - end-to-end policy, approval, audit, and restricted dispatch | Blocked              | Some transport-free primitives were completed in Phase 4                                                                                                         | D-062 identity evidence, O-006 AI-provider configuration, per-provider ZDR evidence, and separately approved coordinator, durable audit, dispatch, execution, and failure semantics |
...
deferred. O-006 remains open for the AI-provider configuration and remaining
identity evidence. D-061 accepts O-007's product policy; each AI provider still
...
2. Complete D-062's exact Microsoft registration, redirect, issuer, audience,
   scope, account, and threat-model evidence; select the AI-provider
   configuration; verify its D-061 ZDR and disclosure prerequisites; and approve
