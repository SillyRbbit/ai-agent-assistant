...
Present exact files, risks, non-goals, tests, verification, and rollback. Wait for approval before editing. Do not mark findings resolved without source and verification evidence or start another remediation automatically.
\`\`\`
```
